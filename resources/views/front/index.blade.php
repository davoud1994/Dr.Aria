					...
					<div class="row">
						...
						<div class="col-lg-6 col-md-7 col-12" id="tel-email">
							...
							<ul class="top-contact">
								...
								<li><a href="mailto:support@yourmail.com">support@yourmail.com<i class="fa fa-envelope"></i></a></li>
							</ul>
							<!-- End Top Contact -->
						</div>
					</div>
							...
							<div class="col-lg-7 col-md-9 col-12" dir="rtl" >
								...
								<div class="main-menu" >
									<nav class="navigation">
										<ul class="nav menu">
											<li class="active"><a href="#">صفحه اصلی <i class="icofont-rounded-down"></i></a>
												{{-- <ul class="dropdown">
